...
if configs.referenceSource ~= "glove"
    error("evaluateCheckpointSuite:IncomparableReferenceSource", ...
        "Agent7250 acceptance metrics are defined only for the glove " + ...
        "reference. Use a source-specific evaluator for emgIntent.");
end
...
row = struct( ...
    ...
    "referenceSource", string(getMetaField(checkpointMeta.override, "referenceSource", "glove")), ...
