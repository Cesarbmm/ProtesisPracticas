...
[selectedAuditRow, selectionMeta] = localSelectBenchmarkCheckpoint(auditResults.phaseBTable);
...
function [selectedRow, meta] = localSelectBenchmarkCheckpoint(phaseBTable)
