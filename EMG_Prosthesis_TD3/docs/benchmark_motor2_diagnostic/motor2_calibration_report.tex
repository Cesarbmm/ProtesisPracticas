...
Primero se evaluo \texttt{Agent7250} congelado con conversion baseline y
\texttt{motor2Calibrated}. No hubo entrenamiento, no se tocaron puertos COM y
todo corrio en simulacion con dataset pregrabado.

\begin{table}[H]
\centering
\caption{Agent7250 congelado con variantes de conversion.}
\begin{tabular}{lrrrrrr}
\toprule
Config & MSE & MSE M2 & Range M2 & MSE M4 & Range M4 & M4 flags \\
\midrule
Baseline & 0.041453 & 0.046330 & 0.109520 & 0.030247 & 0.209431 & 0/0/0 \\
M2Cal -64 & 0.041348 & 0.045885 & 0.110899 & 0.030247 & 0.209431 & 0/0/0 \\
M2Cal -128 & 0.041248 & 0.045462 & 0.112256 & 0.030247 & 0.209431 & 0/0/0 \\
M2Cal -256 & 0.041064 & 0.044679 & 0.114906 & 0.030247 & 0.209431 & 0/0/0 \\
\bottomrule
\end{tabular}
\end{table}
...
M4 viene mas del entrenamiento desde cero, del selector o de la reward, no de
la conversion local de motor 2 por si sola.

\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{all_motor_review/agent7250_frozen_all_motor_comparison_20260622.png}
\caption{Comparacion MATLAB all-motor con \texttt{Agent7250} congelado.}
\end{figure}
...
\begin{table}[H]
\centering
\caption{Agent7250 congelado con correccion aislada de motor 2.}
\begin{tabular}{lrrrrrrr}
\toprule
Config & MSE & MSE M2 & Range M2 & MSE M4 & Range M4 & M4 flags & non-M2 \\
\midrule
Baseline & 0.041453 & 0.046330 & 0.109520 & 0.030247 & 0.209431 & 0/0/0 & 0 \\
M2Cal -256 & 0.041064 & 0.044679 & 0.114906 & 0.030247 & 0.209431 & 0/0/0 & 0 \\
M2 heuristic & 0.041368 & 0.045744 & 0.110305 & 0.030249 & 0.209431 & 0/0/0 & 0 \\
M2 heuristic + M2Cal & 0.040983 & 0.044114 & 0.115666 & 0.030249 & 0.209431 & 0/0/0 & 0 \\
\bottomrule
\end{tabular}
\end{table}

La mejor opcion fue \texttt{Agent7250 + M2 heuristic + motor2Calibrated -256}.
Bajo el MSE global y el MSE de motor 2, subio el rango de motor 2 y mantuvo
M4 sin flags. Esto no promueve la variante como default. Solo cambia la
direccion tecnica: usar \texttt{Agent7250} congelado y corregir motor 2 de
forma aislada antes de volver a entrenamientos largos.

\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{all_motor_review/agent7250_motor2_only_correction_all_motor_comparison_20260623.png}
\caption{Comparacion MATLAB all-motor con correccion aislada de motor 2.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{all_motor_review/agent7250_m2only_heuristic_motor2Calibrated_gap_neg256_episode20_visual_test_20260623.png}
\caption{Test visual MATLAB, episodio 20, Agent7250 congelado con correccion aislada de motor 2 y conversion calibrada.}
\end{figure}
